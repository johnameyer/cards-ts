...
Implementations of a card game must share a certain set of exports to be able to be run, see [Hearts](https://github.com/johnameyer/cards-ts/blob/master/src/hearts/src/index.ts) for an up-to-date example.
