...
export interface Intermediary {
    ...
    form<T extends keyof Presenter>(first: DisplayElement<T>): Promise<[DisplayElementCallReturn<T>]>;
    form<T extends keyof Presenter, U extends keyof Presenter>(first: DisplayElement<T>, second: DisplayElement<U>): Promise<[DisplayElementCallReturn<T>, DisplayElementCallReturn<U>]>;
    form<T extends keyof Presenter, U extends keyof Presenter, V extends keyof Presenter>(first: DisplayElement<T>, second: DisplayElement<U>, third: DisplayElement<V>): Promise<[DisplayElementCallReturn<T>, DisplayElementCallReturn<U>, DisplayElementCallReturn<V>]>;
    form<T extends keyof Presenter, U extends keyof Presenter, V extends keyof Presenter, W extends keyof Presenter>(first: DisplayElement<T>, second: DisplayElement<U>, third: DisplayElement<V>, fourth: DisplayElement<W>): Promise<[DisplayElementCallReturn<T>, DisplayElementCallReturn<U>, DisplayElementCallReturn<V>, DisplayElementCallReturn<W>]>;
    ...
    form(...components: DisplayElement<keyof Presenter>[]): Promise<DisplayElementCallReturn<keyof Presenter>[]>;
}
