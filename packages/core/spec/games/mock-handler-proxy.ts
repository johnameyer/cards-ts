...
import { Params, MockResponseMessage } from '../handlers/mock-handler.js';

export function mockHandlerProxy(players: Handler<Params, Serializable, MockResponseMessage>[]) {
