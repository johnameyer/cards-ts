...
export interface Presenter {
     ...
     * @param options the options to pass
     */
    checkbox<T extends Presentable, ValidateParam extends Serializable = undefined>(options: {
        message: Presentable[];
        choices: { name: string; value: T }[];
        validate?: (input: T[], param: ValidateParam) => true | string | Promise<true | string>;
     ...
     * @param options the options to pass
     */
    input<ValidateParam extends Serializable = undefined>(options: {
        message: Presentable[];
        validate?: (input: string, param: ValidateParam) => true | string | Promise<true | string>;
        validateParam?: ValidateParam;
     ...
     * @param options the options to pass
     */
    place<T extends Presentable, ValidateParam extends Serializable = undefined>(options: {
        message: Presentable[];
        choices: { name: string; value: T }[];
        placeholder: string;
        validate?: (input: number, param: ValidateParam) => true | string | Promise<true | string>;
        validateParam?: ValidateParam;
