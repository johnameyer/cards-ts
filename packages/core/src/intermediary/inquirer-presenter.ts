...
export class InquirerPresenter implements Presenter {
    ...
    checkbox<T, ValidateParam>(options: {
        message: Presentable[];
        type: string;
        choices: { name: string; value: T }[];
        validate?: (input: T[], validateParam: ValidateParam) => true | string | Promise<true | string>;
